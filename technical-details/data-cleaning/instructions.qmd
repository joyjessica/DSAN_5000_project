...
Before processing, the data types summary shows:
| float64 | 346 |
| object | 317 |

After processing and removing rows, the summary shows:
| float64 | 64 |
| object | 4 |
