...
<p align="center">
![Figure 8: Agglomerative clustering results](../images/graphs/agglom.png){width=70% height=auto}
</p>

![Figure 9: Boxplot of agglomerative clusters vs targets](../images/graphs/cluster_box.png){width=100% height=auto}
...
![Figure 9: LASSO regression feature importance](../images/graphs/lasso.png){width=100% height=auto}
...
![Figure 9: Gradient boosting classification feature importancegb](../images/graphs/gb_binary.png){width=100% height=auto}
...
![Figure 9: Gradient boosting classification feature importancegb](../images/graphs/gb_multi.png){width=100% height=auto}
